...
Canvas {
    ...
    Image {
        ...
        x: -200 ; y: 250
        source: "bunny200.png"
        PropertyAnimation on x { to: 400 ; duration: 5000 ; easing.type: Easing.InOutSine }
        SequentialAnimation on y {
            loops: 6
            PropertyAnimation { to : 180 ; duration: 500 ; easing.type : Easing.OutQuad }
            PropertyAnimation { to : 250 ; duration: 500 ; easing.type : Easing.InQuad }
        }
    }
